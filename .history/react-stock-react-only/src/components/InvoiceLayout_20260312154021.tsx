      ...
      <div ref={invoiceRef} className="invoice-preview">
          ...
          <div className="buyer">
            ...
            <div className="buyer-address">
              {invoiceData.buyer_data && (
                <>
                  {invoiceData.buyer_data.nazwa}
                  {'\n'}
                  {invoiceData.buyer_data.addressL1}
                  {'\n'}
                  {invoiceData.buyer_data.addressL2}
                  {'\n'}
                  NIP: {invoiceData.buyer_data.nip}
                  {invoiceData.buyer_data.hasPodmiot3 &&
                    invoiceData.buyer_data.podmiot3 && (
                      <>
                        {'\n\n'}
                        Odbiorca:{'\n'}
                        {invoiceData.buyer_data.podmiot3.nazwa}
                        {'\n'}
                        {invoiceData.buyer_data.podmiot3.addressL1}
                        {'\n'}
        ...
        <div className="qr-code-page">
          ...
          <div className="qr-code-container">
            {/* QR Code will go here when you have the URL */}
            <div className="qr-code-placeholder">{/* QR code image or canvas */}</div>
          </div>
          ...
          <div className="qr-code-link">{verificationUrl}</div>
          <div className="app-footer">Wytworzona w: Stock Recon App v1.0</div>
        </div>
...
InvoiceLayout.propTypes = {
  ...
  invoiceData: PropTypes.shape({
    ...
    buyer_data: PropTypes.shape({
      nazwa: PropTypes.string,
      addressL1: PropTypes.string,
      addressL2: PropTypes.string,
      nip: PropTypes.string,
      hasPodmiot3: PropTypes.bool,
      podmiot3: PropTypes.shape({
        nazwa: PropTypes.string,
        addressL1: PropTypes.string,
        addressL2: PropTypes.string,
        idWew: PropTypes.string,
        rola: PropTypes.string,
      }),
    }),
    startDate: PropTypes.string,
    endDate: PropTypes.string,
...
const Container = styled.div`
  ...
  .bank-account {
    padding: 1rem 0 0.5rem 0; /* was 2.5rem 0 1.2rem 0 */
    font-size: 0.65rem; /* ADD THIS - make tiny */
  }
