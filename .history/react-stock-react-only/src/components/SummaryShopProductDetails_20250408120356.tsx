...
interface SummaryShopProductDetailsProps {
  localSaleData: SaleReturnData[]
  localReturnData: SaleReturnData[]
  shop: string
  productSelected: string
  filteredData: (shop: string, type: string) => SaleReturnData[]
  settingsData: SettingsData
  isOpenIndex: number[]
  index: number
  updateLocalSale: React.Dispatch<React.SetStateAction<SaleReturnData[]>>
  updateLocalReturn: React.Dispatch<React.SetStateAction<SaleReturnData[]>>
}
...
const SummaryShopProductDetails: React.FC<SummaryShopProductDetailsProps> = ({
  ...
  const updateItem = async (quantity: string, dateItem: string, idItem: number) => {
