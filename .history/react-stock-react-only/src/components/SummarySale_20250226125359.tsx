...
import { DataProps } from '../types.ts'
...
interface SaleProps {
  sale?: SaleValue[]
  returns?: SaleValue[]
  extraReturns?: SaleValue[]
  extraSales?: SaleValue[]
}

const SummarySale: React.FC<DataProps> = ({
  sale,
  returns,
  extraReturns,
  extraSales,
  ...
  const calculationByProduct = (productType: string, saleType: SaleItem[]) => {
    return (
      saleType
