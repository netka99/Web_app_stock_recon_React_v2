...
const ExtraSale = forwardRef<HTMLDivElement, ExtraSaleProps>(function ExtraSale(
  {
    unit,
    shopName,
    handleSaveData,
  ...
  const extraValueCurrent = (shop: string): string => {
  ...
  const handleChangeExtra: React.ChangeEventHandler<HTMLInputElement> = (e) => {
