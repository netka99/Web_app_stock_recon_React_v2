...
//   const [localSaleData, setLocalSaleData] = useState(saleData)
//   const [localReturnsData, setLocalReturnsData] = useState(returnsData)
...
//               idx === editIndex ? { ...item, quantity: quantity } : item,
//             ),
//           )
//         }
//       }
...
//   const filteredBySaletype = (typeOfData, minus, typeOfSale) => {
//     const dataToUse = typeOfSale === 'Sale' ? localSaleData : localReturnsData
//     return filteredData(shop, dataToUse).map((item, idx) => (
...
//           <div className="error-notification">{getMessageText(messageText)}</div>
//         )}
//       </div>
//     ))
//   }
...
//         }}
//       >
//         <div className="sale-filered">{filteredBySaletype('Sale', '', 'Sale')}</div>
