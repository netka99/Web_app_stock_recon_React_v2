...
const InvoicePage = () => {
  ...
  const [hasActiveKsefSession, setHasActiveKsefSession] = useState<boolean | null>(null)
  ...
  useEffect(() => {
    checkKsefSession()
      .then((sessions) => setHasActiveKsefSession(sessions.length > 0))
      .catch(() => setHasActiveKsefSession(false))
  }, [])
