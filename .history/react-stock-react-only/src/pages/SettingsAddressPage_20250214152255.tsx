...
const SettingsAddressPage = () => {
  ...
  const [addresses, setAddresses] = useState<Record<string,string | number>>({})
  ...
  const toggleEdit = (shop:string):void => {
    editingShop === shop ? setEditingShop(null) : setEditingShop(shop)
  }

  const changeAddress = (shop:string, value:number):void => {
    setAddresses({
      ...addresses,
      [shop]: value,
    })
