        ...
        <Container>
          <form className="formContainer" onSubmit={(e) => e.preventDefault()}>
            <div className="container">
              {Object.entries(settingsData.prices).map(([productName, price]) => (
                <div className="product_container" key={productName}>
                  <div className="image_label">
                    <img src={pictures[productName]} alt={productName} />
            ...
            <div className="buttons">
              {isDisabled ? (
                ...
                <button className="button_save" type="button" onClick={handleSavePrices}>
                  Zapisz
                </button>
              )}
