...
import { checkKsefSession, authenticateWithKsef } from '../utils/invoiceApi'
  ...
  const handleAuthAndSend = async (skipAuth: boolean = false) => {
    ...
    try {
      ...
      if (response.ok && referenceNumber) {
        ...
        // STEP 5: Get invoice details from KSeF (backend already completed processing)
        showMessage('✅ Faktura wysłana! Pobieranie szczegółów...', 2000)
