  ...
  const fetchDataByAPI = async (
    ...
    try {
      ...
      if (typeof setDatafromAPI === 'function') {
        // If it's a callback function, call it with SaleValue[] data
        ;(setDatafromAPI as (data: SaleValue[]) => void)(data as SaleValue[])
      } else {
        // Otherwise, treat the setter as a direct setter (SettingsData | null)
        setDatafromAPI(data as SettingsData | null)
      }
      // setDatafromAPI(data)
      showMessage('')
      return data
