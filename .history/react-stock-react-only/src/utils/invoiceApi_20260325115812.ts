 ...
 */
export const fetchInvoiceDetails = async (referenceNumber: string): Promise<InvoiceDetails> => {
  try {
 ...
 */
export const fetchAllInvoicesWithDetails = async (shop?: string): Promise<InvoiceDetails[]> => {
  try {
