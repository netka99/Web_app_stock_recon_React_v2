...
const PASSPHRASE = Buffer.from('Jaksiemasz123!!', 'utf-8').toString('base64')
...
// Prepare payload
const payload = {
  certificatePassphrase: 'Jaksiemasz123!!', // Use plain string, not base64
  invoicePayload: invoiceBase64,
}
